...
const Hero = ({bg , video , buttons , header_second , header , text}) => {
  // hover effect
  ...
  return (
    <div className={bg}>
        <div className='hero-content'>
            ...
            </div> : <p style={{width: "40rem", lineHeight: "1.75rem" , fontSize: "1.05rem"}}>{text}</p>
            }
            <div>
                    ...
                    <button  onClick={closeModal}>&times;</button>
                     <div className="modal">
                      <div className="modal-body">
                          <iframe className='video1' allow='autoplay' allowFullScreen frameBorder="0" src='https://player.vimeo.com/video/292387887'></iframe>
                      </div>
                    </div>
                  </div>
                )}
